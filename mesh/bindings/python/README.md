# ATOM Mesh Python Bindings

This directory contains the Python bindings for the ATOM Mesh Router, built using [maturin](https://github.com/PyO3/maturin) and [PyO3](https://github.com/PyO3/pyo3).
...
│   └── mesh_router/      # Python source code
│       ├── __init__.py
│       ├── version.py
│       ├── launch_server.py
│       ├── launch_router.py
...
pip install dist/mesh_router-*.whl
```
...
- **module-name**: `mesh_router.mesh_router_rs` - the Rust extension module name

## Notes

- The Rust bindings source code is located in `src/lib.rs`
- The bindings have their own `Cargo.toml` in this directory
- The main mesh-router library is located in `../../` and is used as a dependency
